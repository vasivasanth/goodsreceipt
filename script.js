...
function addProductRow() {
    ...
    var qty = document.getElementById('receivedquantity').value;
    ...
    var existingRow = Array.from(productTable.rows).find(row => row.cells[1].textContent === product);
...
function clearProductRow() {
    ...
    var edate = document.getElementById('expiryDate');
    var qty = document.getElementById('receivedquantity');
...
function updateProductRow(event) {
    ...
    const productTable = document.getElementById('productTableBody');
    var existingRow = Array.from(productTable.rows).find(row => row !== parentrow && row.cells[1].textContent === product);
    if (existingRow) {
        document.getElementById('errorProductSelect').classList.add('error');
    }
    else {
