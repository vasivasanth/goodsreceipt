...
function listEditRow(button) {
    ...
    let receiptDateReversed = dateFormatChange(row.cells[3].innerText.trim());
...
//Yes for select and Delete Method
...
function loop2() {
    ...
    let selectAllRowCheckbox =document.getElementById('SelectAllProductRow');
